(function() {
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.run = function() {
      var defBufOffset, deltaDefBuf, infBufOffset, onBam, onEnd, onHeader, onSam, options, reader, readingHeader, refs, remainedDefBuf, remainedInfBuf, rstream, _read;
      reader = this;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      ...
      _read = function(defBuf) {
        var bam, bufToInflate, bufsToInflate, e, headerInfo, headerStr, infBuf, infBufChunk, _i, _len, _ref, _ref1, _results;
