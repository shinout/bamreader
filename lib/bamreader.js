...
(function() {
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.beginSamtools = function() {
      var headerLines, lines, onBam, onEnd, onHeader, onSam, options, readingHeader, samtools;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      onHeader = this.onHeader;
      options = this.options;
      samtools = childProcess.spawn("samtools", ["view", "-h", this.bamfile]);
      ...
      return lines.on("data", function(samline) {
