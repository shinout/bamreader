...
(function() {
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.begin = function() {
      var bambuf4h, count, curXi, inflateRaw, inflatedBuffers, lastXi, onBam, onEnd, onHeader, onSam, options, parseBam, readAlignment, readHeader, readingHeader, refs, remainedBuffer, rstream, xi;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      onHeader = this.onHeader;
