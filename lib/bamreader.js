...
(function() {
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.begin = function() {
      var bambuf4h, curXi, inflateRaw, inflatedBuffers, lastXi, onBam, onEnd, onHeader, onSam, options, parseBam, readingHeader, refs, remainedBuffer, rstream, xi;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      onHeader = this.onHeader;
      ...
      return parseBam = function(bambuf, k) {
        var bamline, bams, e, headerStr, _i, _j, _len, _len1, _ref, _results;
        if (readingHeader) {
          bambuf4h = Buffer.concat([bambuf4h, bambuf]);
          try {
            _ref = BAMReader.readHeader(bambuf4h, true), refs = _ref.refs, headerStr = _ref.headerStr, bambuf = _ref.bambuf;
            if (onHeader) {
              onHeader(headerStr);
            }
            if (bambuf.length === 0) {
        ...
        if (onSam) {
          ...
          for (_j = 0, _len1 = bams.length; _j < _len1; _j++) {
            bamline = bams[_j];
            _results.push(onSam(BAMReader.bamToSam(bamline)));
          }
          return _results;
        }
      };
    ...
    BAMReader.readHeader = function(bambuf, ifReturnsBamBuf) {
    ...
    BAMReader.readAlignments = function(buf, refs) {
