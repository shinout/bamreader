  ...
  OutlierFilteredMeanDev = (function() {
    ...
    OutlierFilteredMeanDev.prototype.precalc = function() {
      ...
      return {
        calc: function() {
          var mean, _ref1;
          _ref1 = this.precalc(), total = _ref1.total, squared = _ref1.squared, n = _ref1.n;
          mean = sum / n;
          return {
            mean: mean,
...
(function() {
  ...
  BAMIterator = (function() {
    ...
    BAMIterator.prototype._read = function() {
      var bam, bambuf, bytesize, chunk, current_d_offset, current_i_offset, d_offsets, i_offset, i_offsets, infbuf, infbuf_len, read_size, _ref;
