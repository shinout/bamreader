...
(function() {
  var BAMReader, BGZF_ESTIMATED_LEN, BGZF_HEADER, CIGAR_ARR, FLAGS, SEQ_ARR, childProcess, createInflateRaw, createReadStream, fs, inflateRawSync;
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.begin = function() {
      var bambuf4h, onBam, onEnd, onHeader, onSam, options, readingHeader, refs, remainedBuffer, rstream, _read;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      onHeader = this.onHeader;
      ...
      _read = function(newBuffer) {
        var bambuf, bamline, bams, buf, defBuf, defBufs, e, headerStr, _i, _j, _len, _len1, _ref, _ref1, _results;
          ...
          if (onSam) {
            _results.push((function() {
              ...
              for (_k = 0, _len2 = bams.length; _k < _len2; _k++) {
                bamline = bams[_k];
                _results1.push(onSam(BAMReader.bamToSam(bamline)));
              }
              return _results1;
            })());
          } else {
