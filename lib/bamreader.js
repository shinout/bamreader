(function() {
  ...
  BAMReader = (function() {
    ...
    BAMReader.prototype.begin = function() {
      var onBam, onEnd, onHeader, onSam, options, reader, readingHeader, refs, remainedDefBuf, remainedInfBuf, rstream, _read;
      reader = this;
      onBam = this.onBam;
      onSam = this.onSam;
      onEnd = this.onEnd;
      ...
      _read = function(defBuf) {
        var bam, bufToInflate, bufsToInflate, e, headerInfo, headerStr, infBuf, offset, _i, _len, _ref, _results;
        ...
        for (_i = 0, _len = bufsToInflate.length; _i < _len; _i++) {
          ...
          infBuf = remainedInfBuf.length ? Buffer.concat([remainedInfBuf, inflateRawSync(bufToInflate)]) : inflateRawSync(bufToInflate);
          if (readingHeader) {
            try {
              headerInfo = BAMReader.readHeaderFromInflatedBuffer(infBuf, true);
              refs = headerInfo.refs, headerStr = headerInfo.headerStr;
          ...
          _results.push((function() {
            ...
            while (true) {
              ...
              _ref1 = BAMReader.readAlignmentFromInflatedBuffer(infBuf, refs, reader), bam = _ref1[0], infBuf = _ref1[1], offset = _ref1[2];
              if (bam === null) {
                remainedInfBuf = infBuf;
                break;
              } else {
