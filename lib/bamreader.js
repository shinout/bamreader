(function() {
  var BAMReader, Fifo, INFBUF_CACHE_SIZE, fs, inflateBGZF, isValidBGZF,
    __slice = [].slice;
  ...
  BAMReader = (function() {
    function BAMReader(bamfile, o) {
      ...
      this.infbufs = new Fifo(this.cache_size);
    ...
    BAMReader.prototype.fork = function(o) {
      var child, childs, ended_childs, envs, k, n, num, on_finish, on_message, positions, suffix, v, _i, _j, _len, _o, _ref;
      if (o == null) {
        o = {};
      }
      if (typeof o === "function") {
      ...
      for (n = _j = 0; 0 <= num ? _j < num : _j > num; n = 0 <= num ? ++_j : --_j) {
        ...
        child = module.exports.BAMIterator.create(this, _o);
  ...
  BAM = (function() {
    ...
    defineGetters(BAM.prototype, {
      ...
      sam_rnext: function() {
        if (this.nref_id === -1) {
          return "*";
        } else if (this.ref_id === this.nref_id) {
          return "=";
        } else {
          return this.reader.refs[this.nref_id].name;
        }
      ...
      sam: function() {
        ...
        return this.sam_ = [this.qname, this.flag, this.sam_rname, this.pos, this.mapq, this.sam_cigar, this.sam_rnext, this.pnext, this.tlen, this.seq, this.qual, this.tagstr].join("\t");
      },
      tagstr: function() {
        var name, tag;
        if (this.tagstr_) {
      ...
      tags: function() {
        var arrayLen, buf, buflen, cursor, hLen, i, subtype, tag, tags, valtype, zLen;
        if (this.tags_ != null) {
          return this.tags_;
        }
        tags = {};
